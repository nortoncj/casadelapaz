    ...
    <div class="hero-content">
        <h1 class="hero-title">
            ...
            if (is_category()) {
                ...
                esc_html_e('Blog', 'casadelapaz');
            }
            ?>
        </h1>
        <?php if (is_category() || is_tag()) : ?>
            <p class="hero-description"><?php echo wp_kses_post(term_description()); ?></p>
        <?php endif; ?>
    </div>
</section>
    ...
    <div class="container">
        ...
        <?php else : ?>
            ...
            <div style="text-align: center; padding: var(--space-3xl); background: var(--light-beige); border-radius: var(--radius-md);">
                ...
                <h2><?php esc_html_e('No Posts Found', 'casadelapaz'); ?></h2>
                <p style="font-size: 18px; color: var(--charcoal-gray); margin-bottom: var(--space-lg);">
                    <?php esc_html_e('Sorry, but nothing matched your selection. Please try again with some different keywords.', 'casadelapaz'); ?>
                </p>
